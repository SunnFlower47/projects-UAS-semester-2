    ...
    <div class="bg-transparent backdrop-blur-md rounded-3xl border border-purple-100 shadow-lg p-10">
      <div class="flex flex-col lg:flex-row gap-10">
        ...
        <div class="flex-1 space-y-4">
          ...
          <p class="text-sm text-gray-700">Pengarang: <strong>{{ $pinjaman->book->pengarang }}</strong></p>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 pt-4">
            ...
            <div>
              ...
              @php
                $statusColor = $pinjaman->status === 'terlambat' ? 'red' : ($pinjaman->status === 'dikembalikan' ? 'green' : 'yellow');
              @endphp
