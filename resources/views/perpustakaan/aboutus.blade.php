    ...
    <div class="max-w-6xl mx-auto mt-10 space-y-10">
      ...
      <section class="bg-purple-100 rounded-2xl p-6 md:p-8 shadow-md">
        ...
        <p class="text-base leading-relaxed text-gray-700 text-center">
          Kami memiliki visi untuk menjadi pelopor dalam transformasi digital perpustakaan kampus. Sistem ini diharapkan mampu menjadi jembatan antara kebutuhan informasi dan akses yang mudah bagi seluruh civitas akademika. Kami ingin menciptakan perpustakaan digital yang bukan hanya sekadar tempat pencarian buku, tetapi juga sebagai pusat literasi berbasis teknologi yang mendukung pembelajaran mandiri, kolaboratif, dan berkelanjutan.
        </p>
