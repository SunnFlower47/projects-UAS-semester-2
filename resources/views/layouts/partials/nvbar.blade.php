                ...
                <div class="hidden md:flex items-center space-x-6 text-sm font-medium relative">
                    ...
                    <div class="relative">
                        ...
                        <div
                            ...
                            <a href="{{ route('perpustakaan.pinjaman.histori-pinjaman') }}" class="block px-4 py-2 hover:bg-gray-700 text-sm">Histori Peminjaman</a>
                    ...
                    <div id="mobileSearchForm" class="hidden px-4 mt-4">
                        ...
                        <div
                            ...
                            <div id="mobileMenuContent">
                                ...
                                <a href="{{ route('perpustakaan.pinjaman.histori-pinjaman') }}" class="block py-2 text-lg">Histori Peminjaman</a>
                                <!-- belum diisi -->
                            ...
                            <div class="bg-white rounded-lg overflow-hidden">
                                <div class="flex items-center px-4 py-3  space-x-3">
                                    @php
                                        ...
                                        $mobileAvatarUrl = $mobileHasPhoto
                                            ? asset("storage/{$mobileUser->photo}")
